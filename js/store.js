...
const GLOW = (() => {
  ...
  const SEED_REVIEWS = [
    ...
    { id:"r4", name:"Екатерина С.", city:"Витебск", rating:5, avatar:"👧", text:"Первый раз попробовала санскрин Round Lab — вообще без белёсости и липкости. Теперь мой must-have на лето." },
    { id:"r5", name:"Марина П.", city:"Гродно", rating:4, avatar:"🙎‍♀️", text:"Отличный магазин, цены приятные. Единственное — хотелось бы больше наборов в наличии. Но качеством довольна!" },
    { id:"r6", name:"Наталья Д.", city:"Могилёв", rating:5, avatar:"💁‍♀️", text:"Сыворотка с гиалуронкой Torriden — просто спасение для сухой кожи зимой. Заказ пришёл за два дня, всё целое." },
    { id:"r7", name:"Виктория Л.", city:"Минск", rating:5, avatar:"👱‍♀️", text:"Обожаю тинты rom&nd, тут они всегда в наличии и дешевле, чем в оффлайне. Постоянный клиент теперь :)" },
  ];

  /* ---------- Блог ---------- */
  const SEED_BLOG = [
    { id:"b1", date:"2 июля 2026", title:"Корейский уход за кожей: 10 шагов простым языком", excerpt:"Разбираем, что и в каком порядке наносить, чтобы кожа сияла.", emoji:"📖", cover:"linear-gradient(120deg,#fdeef0,#f8dfe3)", image:"",
      body:"Корейский уход славится многоступенчатостью, но это не значит, что нужно наносить десять средств каждый день. Базовая рутина — это очищение, тонизирование, увлажнение и защита от солнца.\n\nУтром достаточно умыться мягкой пенкой, нанести тонер, сыворотку, увлажняющий крем и обязательно SPF. Вечером добавляется этап снятия макияжа гидрофильным маслом и, при желании, маска или кислотный тонер 1–2 раза в неделю.\n\nГлавное правило — наносить средства от самой лёгкой текстуры к самой плотной и давать каждому слою впитаться 30–60 секунд. Не гонитесь за количеством: три рабочих средства лучше десяти случайных." },
    { id:"b4", date:"24 июня 2026", title:"Двойное очищение: зачем смывать макияж дважды", excerpt:"Гидрофильное масло плюс пенка — основа чистой кожи без стянутости.", emoji:"🧼", cover:"linear-gradient(120deg,#eef1ec,#dee5db)", image:"",
      body:"Двойное очищение — фундамент корейского ухода. Первый шаг — гидрофильное масло или бальзам: они растворяют макияж, SPF и кожное сало, которые не смываются водой.\n\nВторой шаг — мягкая пенка или гель на водной основе. Она убирает остатки масла и загрязнения, не разрушая защитный барьер кожи. После правильного очищения не должно быть ощущения стянутости.\n\nУтром двойное очищение не обязательно — достаточно умыться пенкой или просто освежить кожу тонером. А вот вечером это must-have, особенно если вы носите макияж или SPF." },
    { id:"b5", date:"18 июня 2026", title:"Как совмещать активы: ниацинамид, витамин C и ретинол", excerpt:"Простые правила, чтобы активные ингредиенты работали, а не конфликтовали.", emoji:"🧪", cover:"linear-gradient(120deg,#f3f0ec,#e9e2d6)", image:"",
      body:"Витамин C лучше использовать утром — он работает как антиоксидант и усиливает защиту от солнца. Не забудьте нанести SPF сверху.\n\nРетинол — вечерний ингредиент. Он обновляет кожу, но повышает чувствительность к солнцу, поэтому наносится только на ночь и вводится постепенно: 1–2 раза в неделю, затем чаще.\n\nНиацинамид универсален и дружит почти со всем — он успокаивает, сужает поры и выравнивает тон. Если кожа реагирует раздражением на сочетание активов, разведите их по разным дням. Меньше — часто значит лучше." },
    { id:"b2", date:"10 июня 2026", title:"Муцин улитки: чем полезен и кому подойдёт", excerpt:"Главный ингредиент K-beauty и как его правильно использовать.", emoji:"🐌", cover:"linear-gradient(120deg,#f0e8e3,#e2d6cd)", image:"",
      body:"Муцин улитки — это секрет, богатый гиалуроновой кислотой, гликопротеинами, пептидами и антиоксидантами. Он увлажняет, ускоряет восстановление кожи и помогает выровнять тон.\n\nЛучше всего муцин работает в формате эссенции или сыворотки, нанесённой на влажную кожу после тонера. Подходит практически всем типам кожи, включая чувствительную.\n\nЕсли у вас аллергия на морепродукты — это не противопоказание, но первый раз стоит протестировать средство на небольшом участке кожи." },
    { id:"b6", date:"3 июня 2026", title:"Уход по типу кожи: находим свою рутину", excerpt:"Сухая, жирная, комбинированная или чувствительная — у каждой свои акценты.", emoji:"🧴", cover:"linear-gradient(120deg,#f0f0f1,#e3e4e6)", image:"",
      body:"Сухой коже нужны насыщенные текстуры и восстановление барьера: ищите керамиды, сквалан и гиалуроновую кислоту, избегайте агрессивных кислот каждый день.\n\nЖирной и комбинированной коже подойдут лёгкие гелевые текстуры, ниацинамид и мягкое отшелушивание с BHA. Не пересушивайте кожу — в ответ она вырабатывает ещё больше себума.\n\nЧувствительной коже важны минимальные составы без спирта и отдушек, с центеллой и пантенолом. Вводите новые средства по одному, чтобы понимать, на что реагирует кожа." },
    ...
    { id:"b7", date:"20 мая 2026", title:"Тканевые маски: выжимаем максимум пользы", excerpt:"Как получить от маски-салфетки максимум и не пересушить кожу.", emoji:"🧖‍♀️", cover:"linear-gradient(120deg,#fdeef0,#f8dfe3)", image:"",
      body:"Тканевая маска — это концентрат ухода и приятный ритуал. Наносите её на очищенную кожу после тонера и держите 15–20 минут, не дольше: подсыхая, маска начинает забирать влагу обратно.\n\nПосле снятия не смывайте эссенцию, а вбейте остатки в кожу подушечками пальцев. Сверху закрепите результат кремом, чтобы влага не испарилась.\n\nОптимально — 2–3 раза в неделю. Для усиления эффекта храните маску в холодильнике: прохлада тонизирует и снимает отёчность." },
  ];
